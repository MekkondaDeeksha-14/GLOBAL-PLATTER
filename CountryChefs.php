...
for ($i = 0; $i < 3; $i++) {
    ...
    $chef_dishes = array_slice($dish_pool, 0, rand(2, 3));
...
<a class="book-btn"
   href="book_slot.php?chef=<?php echo urlencode($chef['chef_name']); ?>
   &cost=<?php echo $chef['cost']; ?>
   &country=<?php echo urlencode($country); ?>
   &dishes=<?php echo urlencode(json_encode($chef['dishes'])); ?>">
   Book Slot
</a>
